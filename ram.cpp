...
class student_data
{
    private :
        ...
        struct profile std_db[15]={"Kasim", "Chhota", 9.89, 23232, "Sudarshan", "Kumar", 9.8, 23231, "Ronak", "Agrawal", 9.54, 23222, "Pratik", "Kape", 9.12, 23224, "jay", "Kumar", 9.65, 23228, "Kunal", "Divekar", 9.5, 23235, "Mihir", "Inamdar", 9.01, 23230, "Sanika", "Mote", 9.2, 23234, "Atharva", "Kamble", 9.8, 23241, "Munshi", "Prem", 9.45, 23238, "Kalyani", "Nilpankar", 8.97, 23237, "Tanmay", "Goregaonkar", 8.85, 23227, "Shruti", "Jagdale", 9.74, 23233, "Sandesh", "Dholas", 8.86, 23223, "Akshay", "K", 8.98, 23242};
        int n = 15;
